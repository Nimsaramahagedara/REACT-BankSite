...
const Hero = () => (
    <section className={`flex md:flex-row flex-col ${style.paddingY}`}>
      <div className={`flex-1 ${style.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
        ...
        <p className={`${style.paragraph} max-w-[470px] mt-5`}>Lorem ipsum dolor sit amet consectetur adipisicing elit. In, minima asperiores nostrum explicabo, et, quas consequuntur numquam nesciunt temporibus magni fugiat voluptatibus dolorum laborum doloribus dolores ut beatae excepturi saepe?</p>
      </div>
